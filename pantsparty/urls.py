...
urlpatterns = patterns("",
                       ...
                       url(r"^rest-auth/facebook/$", FacebookLogin.as_view(),
                           name="fb_login"),
                       url(r"^rest-auth/twitter/$", TwitterLogin.as_view(),
                           name="twitter_login"),
                       url(r"^api/$", api_root),
                       url(r"^api/punchlines/$", PunchlineList.as_view(),
                           name="punchline-list"),
                       url(r"^api/comments/$", CommentList.as_view(),
                           name="comment-list"),
                       url(r"^api/verify-token/(?P<token>[\w-]+)/$",
                           VerifyTokenView.as_view(), name="verify-token"),
                       url(r"^api/jokes/$", JokeList.as_view(),
                           name="joke-list"),
                       url(r"^api/jokes/create/$", JokeCreate.as_view(),
                           name="joke-create"),
                       url(r"^api/joke_categories/$",
                           JokeCategoryList.as_view(),
                           name="joke-category-list"),
                       url(r"^api/jokes/(?P<pk>\d+)/$", JokeDetail.as_view(),
                           name="joke-detail"),
                       url(r"^api/votes/$", JokeVoteList.as_view(),
                           name="joke-votes"),
                       url(r"^api/users/me/$", MeList.as_view(), name="me"),
                       url(r"^api/username/available/(?P<username>\w+)/$",
                           UsernameAvailable.as_view(), name="available"),
                       ...
                       url(r"^api/blogs/$", BlogPostList.as_view(),
                           name="blog-list"),
                       url(r"^api/blogs/(?P<slug>[\w-]+)/$",
                           BlogPostDetail.as_view(), name="blog-detail"), )
